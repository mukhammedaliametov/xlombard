      ...
      <div className="max-w-[1280px] mx-auto px-[16px] font-inter flex flex-col md:flex-row items-top justify-between">
        <div>
          ...
          <div className="flex flex-col gap-[30px]">
            <div className="flex flex-col md:flex-row items-top gap-[20px] mt-[40px]">
              <img src={Contact1} alt="contact1" className='w-[120px] mb-[-40px] md:mb-0 md:w-auto' />
              <div className="">
                <h3 className="text-[24px] mb-[5px]">Пишите нам</h3>
                <p className="text-primary-gray">в мессенджеры на +7 (968) 096-59-40</p>
            ...
            <div className="flex flex-col md:flex-row items-top gap-[20px]">
              <img src={Contact2} alt="contact1" className='w-[120px] mb-[-40px] md:mb-0 md:w-auto' />
              <div className="">
            ...
            <div className="flex flex-col md:flex-row items-top gap-[20px]">
              <img src={Contact3} alt="contact1" className='w-[120px] mb-[-40px] md:mb-0 md:w-auto' />
              <div className="">
                <h3 className="text-[24px] mb-[5px]">Приезжайте</h3>
                <p className="text-primary-gray">Москва, ул. 3-я Северная линия, д. 14, оф. 2</p>
        ...
        <form className="w-full md:w-[583px] mt-[30px] md:mt-0 rounded-[20px] bg-white p-[20px] md:p-[40px] flex flex-col gap-[20px]">
          <h4 className="text-[20px] md:text-[30px]">
            Ответим на любые вопросы: <span className="text-primary-blue">расскажем, покажем и дадим попробовать</span>
          </h4>
          <p>Проведём онлайн демонстрацию по Zoom!</p>
          <input type="text" placeholder="Как к вам обращаться (ваше имя)" className="border border-[#00000093] py-[10px] px-[20px] rounded-[10px] focus:border-primary-blue duration-300 outline-none" />
          <input
            type="text"
            placeholder="Телефон, чтобы мы могли перезвонить" className="border border-[#00000093] py-[10px] px-[20px] rounded-[10px] focus:border-primary-blue duration-300 outline-none"
          />
          <input
            type="email"
            placeholder="Электронная почта для отправки ответа" className="border border-[#00000093] py-[10px] px-[20px] rounded-[10px] focus:border-primary-blue duration-300 outline-none"
          />
          <textarea placeholder="Ваш вопрос" className="border border-[#00000093] py-[10px] px-[20px] rounded-[10px] focus:border-primary-blue duration-300 outline-none"></textarea>
